...
public class PostExtractionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_extraction);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.btn_detail_nilai:
                Intent intent = new Intent(this, DetailNilaiPostExtraction.class);
